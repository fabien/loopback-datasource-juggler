...
RelationDefinition.prototype.primaryKey = function() {
  if (!this.modelTo) return 'id';
  return this.modelTo.definition.idName() || 'id';
};
...
HasMany.prototype.removeFromCache = function (id) {
  ...
  var idName = this.definition.primaryKey();
...
RelationDefinition.hasMany = function hasMany(modelFrom, modelTo, params) {
  ...
  var pk = params.primaryKey || modelFrom.dataSource.idName(modelFrom.modelName);
...
RelationDefinition.belongsTo = function (modelFrom, modelTo, params) {
  ...
  if (params.polymorphic) {
    ...
    pk = params.primaryKey || modelFrom.dataSource.idName(modelTo.modelName);
...
RelationDefinition.embedsMany = function embedsMany(modelFrom, modelTo, params) {
  ...
  var fk = modelTo.dataSource.idName(modelTo.modelName);
  var pk = modelFrom.dataSource.idName(modelFrom.modelName);
